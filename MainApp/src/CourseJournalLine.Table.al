table 50105 "Course Journal Line"
{
    ...
    fields
    {
        ...
        field(6; "Course No."; Code[20])
        {
            ...
            begin
                ...
                // Res.Get("Course No.");
                // Res.CheckCoursePrivacyBlocked(false);
                // Res.TestField(Blocked, false);
                // OnValidateCourseNoOnAfterChecks(Res, Rec, xRec);

                // Description := Res.Name;
                // "Direct Unit Cost" := Res."Direct Unit Cost";
                // "Unit Cost" := Res."Unit Cost";
                // "Unit Price" := Res."Unit Price";
                // "Course Group No." := Res."Course Group No.";
                // "Work Type Code" := '';
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyResJnlLineFromSalesHeader(var SalesHeader: Record "Sales Header"; var ResJournalLine: Record "Course Journal Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyResJnlLineFromSalesLine(var SalesLine: Record "Sales Line"; var ResJnlLine: Record "Course Journal Line")
    begin
    end;
    ...
    // [IntegrationEvent(false, false)]
    // local procedure OnValidateCourseNoOnAfterChecks(var Course: Record Course; var ResJournalLine: Record "Res. Journal Line"; xResJournalLine: Record "Res. Journal Line")
    // begin
    // end;
}